...
import { ExecuteCommentReport, ResponseCommentReport, GetReportSystem, ReceiveReport, ResponseReport } from '../apis/reportAPI';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faCheckToSlot, faPaperPlane } from '@fortawesome/free-solid-svg-icons';

const ReportSystemManagement = ({searchType, searchTerm}) => {
...
export default ReportSystemManagement;
...
import { SearchMovieByNation } from '../apis/movieAPI';
...
const ListNationFilm = () => {
    ...
    const fetchMovies = async (page) => {   
        ...
        try {
            ...
            //     }
            // });
            const response = await SearchMovieByNation(nationSlug, page, itemsPerPage);
    ...
    useEffect(() => {
        ...
        fetchMovies(page);
        // Đảm bảo cuộn lên đầu **sau khi render page mới**
        setTimeout(() => {
            window.scrollTo({ top: 0, behavior: 'smooth' });
        }, 100); // delay nhỏ để đảm bảo layout đã hiển thị
    }, [nationSlug, location.search]);
            ...
            <div className='container'>
                <div className='row'>
                    <div className="d-flex justify-content-between align-items-center">
                        <h4 className="ms-2"><b>Danh sách phim có quốc gia {currentMovies?.length > 0 ? currentMovies[0].nation : ''}</b></h4>
                    </div>
                </div>

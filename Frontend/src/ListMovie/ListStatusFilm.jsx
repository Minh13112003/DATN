...
const ListStatusFilm = () => {
    ...
    const fetchMovies = async (page) => {   
        ...
        try {
            ...
            //     }
            // });
            const response = await SearchMovieByStatus(movieStatusSlug, page, itemsPerPage);
            ...
            <div className='container'>
                <div className='row'>
                    <div className="d-flex justify-content-between align-items-center">
                        <h4 className="ms-2"><b>Danh sách phim {currentMovies?.length > 0 ? currentMovies[0].statusText : 'Phim'}</b></h4>
                    </div>
                </div>
